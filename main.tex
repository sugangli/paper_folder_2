...
\input{proposal-specific-materials}
...
\pagebreak
%\input{related}
\input{boilerplates/education}
\input{boilerplates/prior}

% Collaboration Plan
\clearpage
\pagenumbering{arabic}
\def\thepage{C-\arabic{page}}
\input{boilerplates/collaborationplan}

% Data Management Plan
\clearpage
\pagenumbering{arabic}
\def\thepage{D-\arabic{page}}
\input{boilerplates/datamanagementplan}

% Postdoc Mentoring Plan
\clearpage
\pagenumbering{arabic}
\def\thepage{M-\arabic{page}}
\input{boilerplates/postdoc}

% Facilities
\clearpage
\pagenumbering{arabic}
\def\thepage{F-\arabic{page}}
\input{boilerplates/facilities}
